...
Cometa::Cometa(float pos_x, float pos_y, float vit_x, float vit_y)
{
    pos2.x = pos_x;
    pos2.y = pos_y;
    viteza.x = vit_x;
    ...
    texture.loadFromFile("C:\\Proiect POO v2\\Textures\\cometa.jpg");
    dr.setTexture(&texture);

}
void Cometa::render(RenderWindow& obj)
{
    dr.setPosition(pos2);
    obj.draw(dr);
}
void Cometa::Interactiune2(Planeta& p)
{
